...
class _CollectionCreatePageState extends ConsumerState<CollectionCreatePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(AppLocalizations.of(context).createCollection)),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              AppLocalizations.of(context).addFromFavorites,
  ...
  Future<void> _onSubmit() async {
    ...
    try {
      ...
      await repository.createCollection(
        ...
        recipeIds: _selectedRecipeIds.isEmpty ? null : _selectedRecipeIds.toList(),
      );
